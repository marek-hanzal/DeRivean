...
class Initiative : AbstractInitiative() {
	...
	override fun resolve(formation: Formation) = formation.map.maxByOrNull { it.value.currentInitiative() }?.value ?: throw NoInitiativeException("Cannot resolve initiative from Formation.")
