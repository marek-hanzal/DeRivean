...
class Fireball : AbstractMutator() {
	override fun mutate(entity: Entity, vararg targets: Entity) {
		 ...
		 */
		val attack = (entity.fireAttack() + entity.fireballAttack()) * (1 + entity.fireElement())

		/**
		 * Take cost of casting fireball and mark it as mana loss (decrease).
		 */
		entity.mana(entity.mana() - entity.fireballCost())
		...
		for (target in targets) {
			 ...
			 */
			entity.fireDamage(entity.fireDamage() + damage)
			/**
