...
fun Mutator.fireAttack() = this.member.fireAttack() + this.attributes.fireAttack()
...
fun Mutator.fireDefense() = this.member.fireDefense() + this.attributes.fireDefense()
...
fun Mutator.fireElement() = this.member.fireElement() + this.attributes.fireElement()
...
fun Mutator.fireDamage() = this.member.fireDamage() + this.attributes.fireDamage()
