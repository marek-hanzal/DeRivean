...
import {TranslationMenuRoute} from "site/root/module/translation/site/Menu";
import {TranslationRoute} from "site/root/module/translation/site/Router";
import {UserMenuRoute} from "site/root/module/user/site/Menu";
			...
			menu={
				<BaseRoutes
					routes={[
						...
						route("*", <BaseMenu>
							{/*<MenuDivider/>*/}
							{/*<MenuItem key={"root.home"} href={Routes.root.link()} icon={<HomeIcon/>}/>*/}
							{/*<MenuDivider/>*/}
