			...
			routes={[
				route(Routes.root.building.dashboard.match(), <BaseBreadcrumbs
					items={[
						...
						breadcrumbItem(Routes.root.kingdom.home.link(), "root.kingdom.home", <KingdomIcon/>),
				...
				/>),
				route(Routes.root.building.home.match(), <BaseBreadcrumbs
					items={[
						breadcrumbIconItem(Routes.root.link(), <HomeIcon/>),
						breadcrumbItem(Routes.root.user.list.link(), "root.user.list", <UserIcon/>),
						breadcrumbSimpleItem("root.building.home", <BuildingIcon/>),
					]}
				/>),
			]}
		/>
