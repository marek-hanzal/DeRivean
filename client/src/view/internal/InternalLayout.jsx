...
const InternalLayout = (
	...
	<Spin spinning={loading} tip={t('internal.spinner')}>
		...
		<Layout style={{minHeight: '100vh'}}>
			...
			>
				<InternalMenu open={isCollapsed ? [] : open} selected={selected}/>
			</Layout.Sider>
			<Layout style={isCollapsed ? {
				...
				<Row type='flex' justify='center'>
					<Col span={23}>
						...
						<Layout.Footer style={{textAlign: 'center'}}><InternalFooter/></Layout.Footer>
					</Col>
				</Row>
			</Layout>
		</Layout>
...
)(withTranslation()(InternalLayout));
